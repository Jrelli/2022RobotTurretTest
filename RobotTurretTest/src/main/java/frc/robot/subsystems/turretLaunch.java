...
public class turretLaunch extends SubsystemBase {

    private WPI_TalonFX m_turretLaunch;
    private WPI_TalonFX m_turretAccel;
    private WPI_TalonSRX m_turretIndex;

    public turretLaunch() {
        m_turretLaunch = new WPI_TalonFX(Constants.TURRET_LAUNCH_ID);
        RobotContainer.configureTalonFX(m_turretLaunch, false, false, Constants.TURRET_LAUNCH_F, Constants.TURRET_LAUNCH_P, 
    ...
    public double getLaunchVel(){
        return m_turretLaunch.getSelectedSensorVelocity();
    }
}