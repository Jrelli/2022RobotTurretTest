...
public class swerveModule extends SubsystemBase{
  ...
  public swerveModule(int driveMotorId, int turningMotorId, boolean driveMotorReversed, boolean turningMotorReversed, int absoluteEncoderId){
    ...
    m_drivePIDController =   new PIDController(Constants.K_CHASSIS_TURN_P, Constants.K_CHASSIS_TURN_I, Constants.K_CHASSIS_TURN_D);
    m_turningPIDController = new ProfiledPIDController(Constants.K_CHASSIS_RIGHT_ANGLE_P, Constants.K_CHASSIS_RIGHT_ANGLE_I, 
    ...
    m_driveFeedforward = new SimpleMotorFeedforward(Constants.K_STATIC_VOLT, Constants.K_VELOCITY_VOLT, Constants.K_ACCELERATION_VOLT);
    m_turnFeedforward = new SimpleMotorFeedforward(Constants.K_STATIC_VOLT, Constants.K_VELOCITY_VOLT, Constants.K_ACCELERATION_VOLT);
  ...
  public void setDesiredState(SwerveModuleState desiredState){
    ...
    //Set output for drive & turn motors
